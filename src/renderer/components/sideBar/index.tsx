...
import { configType } from "../scroll/type";
...
export default memo(() => {
  ...
  // 滚动配置
  const config: configType = { customConfig: { useDefaultClass: false, showScrollBar: folded }, scrollConfig: { bounce: false } };
  ...
  return (
    ...
    <Context.Provider value={{ to, folded, currentRoute: location.pathname }}>
      ...
      >
        ...
        <Scroll config={config} className="relative h-full overflow-hidden px-3">
          <div>
